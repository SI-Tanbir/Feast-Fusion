  ...
  return (
    <div>
      ...
      >
        ...
        <SwiperSlide>
          <img src={slider1} alt="" />
          <p className="-mt-12 text-3xl text-white text-center uppercase">
            Salad
          </p>
        </SwiperSlide>
        <SwiperSlide>
      ...
      <div className="relative m-4">
        ...
        <div className="absolute top-[30%] m-4 p-16 left-0 text-center bg-slate-100">
          ...
          <p>
            ...
            rerum velit totam animi blanditiis sequi eveniet neque odio
            pariatur, corporis cupiditate quo ex illum eligendi ut omnis numquam
            sunt aliquam.
      ...
      <div className="  text-white p-8 m-auto text-3xl max-w-[1200px] text-center bg-black">
        {" "}
        Call us: +80079709089{" "}
      </div>
